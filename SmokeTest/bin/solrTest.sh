...
rc=$?; if [[ $rc != 0 ]]; then echo "Change dirctory command failed! exiting"; echo " - Solr		- Failed [Change dirctory command failed]" >> ./log/${timestamp}SummaryReport.txt; exit $rc; fi
