...
if [[ $rc != 0 ]]; then
  ...
  echo " - Ozone        - Failed [Error in showing buckets in Ozone]" >> ./log/SummaryReport.txt
  exit $rc
fi
...
if [[ $rc != 0 ]]; then
  ...
  echo " - Ozone        - Failed [Error in creating volume and bucket in Ozone]" >> ./log/SummaryReport.txt
  exit $rc
fi
...
if [[ $rc != 0 ]]; then
  ...
  echo " - Ozone        - Failed [Error in copying file to Ozone]" >> ./log/SummaryReport.txt
  exit $rc
fi
...
if [[ $rc != 0 ]]; then
  ...
  echo " - Ozone        - Failed [Error in copying file from Ozone]" >> ./log/SummaryReport.txt
  exit $rc
fi
...
if [[ $rc != 0 ]]; then
  ...
  echo " - Ozone        - Failed [Error in showing copied file from Ozone]" >> ./log/SummaryReport.txt
  exit $rc
fi
...
if [[ $status = 0 ]]; then
    ...
    echo " - Ozone        - Passed" >> ./log/SummaryReport.txt
    echo "***************************************"
    echo "* Ozone test completed Successfully ! *"
    echo "***************************************"
else
    echo "Files are different"
    echo " - Ozone        - Failed[Files are different]" >> ./log/SummaryReport.txt
    echo "***********************"
